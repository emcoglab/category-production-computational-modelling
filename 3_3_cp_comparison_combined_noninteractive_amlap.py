...
def main(input_results_dir_sensorimotor: str,
    ...
    evaluation_save_dir = path.join("/Users/cai/Box Sync/LANGBOOT Project/Conferences/AMLaP 2020/graphs", MODEL_TYPE.model_output_dirname,
    ...
    figures_dir = path.join("/Users/cai/Box Sync/LANGBOOT Project/Conferences/AMLaP 2020/graphs", MODEL_TYPE.figures_dirname,
                            f"{input_results_dir_linguistic.parent.name} {input_results_dir_linguistic.name}",
                            f"{input_results_dir_sensorimotor.parent.name} {input_results_dir_sensorimotor.name}")
