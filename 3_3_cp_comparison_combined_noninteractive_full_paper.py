...
from evaluation.category_production import add_ttfa_column, ModelType, \
    ...
    save_hitrate_graphs, save_hitrate_summary_tables, save_item_level_data
...
def main(input_results_dir_sensorimotor: str,
    ...
    evaluation_save_dir = path.join("/Users/cai/Box Sync/LANGBOOT Project/Manuscripts/Category Production - Full Paper/Data/Evaluation/extra/graphs", MODEL_TYPE.model_output_dirname,
    ...
    figures_dir = path.join("/Users/cai/Box Sync/LANGBOOT Project/Manuscripts/Category Production - Full Paper/Data/Evaluation/extra/graphs", MODEL_TYPE.figures_dirname,
                            f"{input_results_dir_linguistic.parent.name} {input_results_dir_linguistic.name}",
                            f"{input_results_dir_sensorimotor.parent.name} {input_results_dir_sensorimotor.name}")
    ...
    if manual_cut_off is None:
        ...
        hrs_rpf, hrs_rmr = get_hitrate_summary_tables(cutoff_data, MODEL_TYPE)
        save_hitrate_summary_tables(hrs_rmr, hrs_rpf, MODEL_TYPE, file_suffix + f" manual combined ({manual_cut_off})", output_dir="/Users/cai/Box Sync/LANGBOOT Project/Manuscripts/Category Production - Full Paper/Data/Evaluation/extra")
        ...
        save_item_level_data(cutoff_data, path.join("/Users/cai/Box Sync/LANGBOOT Project/Manuscripts/Category Production - Full Paper/Data/Evaluation/extra",
                                                    f"item-level data ({model_identifier}).csv"))

        # linguistic
        cutoff_data = apply_cutoff(main_data, TTFA_LINGUISTIC, manual_cut_off)
        hrs_rpf, hrs_rmr = get_hitrate_summary_tables(cutoff_data, MODEL_TYPE)
        save_hitrate_summary_tables(hrs_rmr, hrs_rpf, MODEL_TYPE, file_suffix + f" manual linguistic ({manual_cut_off})", output_dir="/Users/cai/Box Sync/LANGBOOT Project/Manuscripts/Category Production - Full Paper/Data/Evaluation/extra")
        ...
        hrs_rpf, hrs_rmr = get_hitrate_summary_tables(cutoff_data, MODEL_TYPE)
        save_hitrate_summary_tables(hrs_rmr, hrs_rpf, MODEL_TYPE, file_suffix + f" manual sensorimotor ({manual_cut_off})", output_dir="/Users/cai/Box Sync/LANGBOOT Project/Manuscripts/Category Production - Full Paper/Data/Evaluation/extra")
