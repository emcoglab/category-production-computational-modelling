...
from evaluation.category_production import ModelType, CATEGORY_PRODUCTION, add_rfop_column, add_rmr_column, \
    ...
    save_hitrate_summary_tables, save_naïve_model_performance_stats, drop_missing_data
...
def main(input_results_dir: str):
    ...
    main_data = compile_model_data(input_results_dir)
    process_one_model_output(main_data, input_results_dir)


def compile_model_data(input_results_dir) -> DataFrame:
