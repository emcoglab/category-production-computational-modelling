...
for firing_threshold in firing_thresholds:
    ...
    with open(path.join(job_name, name), mode="w", encoding="utf-8") as job_file:
        ...
        job_file.write(f"#$ -N j22_{k}_{importance_threshold}im_ft{firing_threshold}\n")
...
with open("job_2_2_param_search_submit_ALL.sh", mode="w", encoding="utf-8") as batch_file:
